...
{
    internal class GridRebuilder<TData, TElement>
        where TElement : Component
    {
        private readonly IList<TData> _dataSource;
        private readonly Grid<TElement> _grid;
        private readonly GridRebuilderConfig<TData, TElement> _config;
        ...
        public GridRebuilder(IList<TData> dataSource, Grid<TElement> grid, GridRebuilderConfig<TData, TElement> config)
        {
        ...
        private void SyncGroups()
        {
            ...
            while (_grid.GroupsCount < _requiredGroupCount)
            {
                ...
                _grid.AddGroup(new GridGroup<TElement>(root));
            }
        }
        ...
        private void SyncPlaceholders(GridGroup<TElement> group)
        {
        ...
        private void SetElementsPlaceholdersOrder(GridGroup<TElement> group)
        {
            var sibling = 0;
