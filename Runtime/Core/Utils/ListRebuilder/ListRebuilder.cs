...
namespace WhiteArrow.ReactiveUI.Core
{
        ...
        where TElement : Component
    {
        ...
        public ListRebuilder(IList<TData> dataSource, IList<TElement> elementsSource, ListRebuilderConfig<TData, TElement> config)
        {
