...
namespace WhiteArrow.ReactiveUI.Components
{
    public abstract class Selector : UIView
    {
        ...
        public abstract ISelection UntypedPreviousConfirmedSelection { get; }
        public abstract ReadOnlyReactiveProperty<bool> HasConfirmedSelection { get; }
        ...
        where TOption : SelectorOption<TData>
    {
        ...
        private Selection<TData> _previousConfirmedSelection;
        ...
        public override ISelection UntypedPreviousConfirmedSelection => _previousConfirmedSelection;
        public Selection<TData> PreviousConfirmedSelection => _previousConfirmedSelection;

        private ReadOnlyReactiveProperty<bool> _hasConfirmedSelection;
        ...
        public override sealed ReadOnlyReactiveProperty<bool> HasConfirmedSelection => _hasConfirmedSelection;
        ...
        protected override void Init()
        {
            ...
            _hasConfirmedSelection = _confirmedSelection
                .Select(v => v != null)
                .ToReadOnlyReactiveProperty();
        ...
        public override sealed void ConfirmCurrentSelection()
        {
            ...
            _previousConfirmedSelection = _confirmedSelection.Value;
